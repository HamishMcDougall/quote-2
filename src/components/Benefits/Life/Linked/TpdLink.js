...
import {  Row, Col, Input, Checkbox, Radio, Menu, Dropdown, Icon } from 'antd';
   ...
   const radioStyle = {
      ...
      const menu = (
        <Menu>
          <Menu.Item>
            <a target="_blank" rel="noopener noreferrer" href="#">Individual</a>
          </Menu.Item>
          <Menu.Item>
...
class TpdLink extends Component {
    ...
    return (
      ...
      <Row gutter={16}>
        ...
        <Col className="gutter-row" span={18}>
          ...
          <h5><Icon type="link" />&nbsp; <b>Linked Total & Permanent Disability Cover</b></h5>
          </div>
        </Col>
              ...
              <Col className="gutter-row" span={12}>
                <div className="gutter-box">
                  ...
                  <RadioGroup onChange={this.radioOnChange.bind(this)} value={this.state.value}>
                      ...
                      <Radio style={radioStyle} value={3}>Activities of Daily Living</Radio>
                    </RadioGroup>
              ...
              <Col className="gutter-row" span={12}>
                <div className="gutter-box">
                    Additional Options <br/><br/>
                      ...
                      <Checkbox onChange={this.checkOnChange.bind(this)}>Death Buyback</Checkbox>
                </div>
              </Col>
            </Row>
